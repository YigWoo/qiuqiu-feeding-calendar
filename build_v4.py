...
html = r'''<!doctype html>
<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="theme-color" content="#fff9f4"><title>球球今天吃什么</title><style>
:root{--ink:#3e342c;--muted:#756860;--cream:#fff9f4;--card:#fffefa;--green:#a65f3c;--mint:#f7ead7;--amber:#fff0c9;--rose:#fff1ee;--line:#eedfd5;--shadow:0 8px 28px rgba(91,59,40,.09)}*{box-sizing:border-box}body{margin:0;background:var(--cream);color:var(--ink);font:17px/1.55 -apple-system,BlinkMacSystemFont,"PingFang SC","Microsoft YaHei",sans-serif}.shell{max-width:650px;margin:auto;padding:16px 13px 55px}.top{display:flex;justify-content:space-between;align-items:center;margin:2px 0 14px}.brand{font-size:22px;font-weight:850;letter-spacing:.2px}.brand small{display:block;font-size:13px;color:var(--muted);font-weight:600}.card{background:var(--card);border:1px solid var(--line);border-radius:21px;padding:17px;margin:12px 0;box-shadow:var(--shadow)}.hero{background:linear-gradient(135deg,#f9e7d7,#fffaf1)}.date{font-size:15px;color:var(--muted);font-weight:700}.title{font-size:29px;line-height:1.18;margin:5px 0 7px;font-weight:900}.badge{display:inline-block;border-radius:999px;background:var(--green);color:#fff;padding:4px 11px;font-weight:800;font-size:14px}.status{margin-top:11px;color:#6a5649;font-size:15px}.meal{padding:15px 0;border-bottom:1px solid var(--line)}.meal:last-child{border-bottom:0}.meal h2{font-size:20px;margin:0 0 10px}.foodGrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.foodItem{min-width:0;border:1px solid var(--line);border-radius:16px;background:#fffaf5;padding:9px;display:flex;gap:9px;align-items:center}.foodPic{flex:0 0 58px;width:58px;height:58px;border-radius:14px;overflow:hidden;background:#f8ece1}.foodPic img{display:block;width:58px;height:58px}.foodName{font-weight:850;line-height:1.35;font-size:15px;word-break:break-word}.foodSub{font-size:12px;color:var(--muted);margin-top:3px}.mealFull{margin:10px 0 0;padding:9px 10px;border-radius:11px;background:#f5f8f4;font-size:13px;color:#526158}.food{font-weight:700;line-height:1.55}.dash{color:#93a099}.tag{font-size:13px;color:var(--muted);margin-top:5px}.notice{background:var(--amber);border-color:#f0dd93}.notice.warn{background:var(--rose);border-color:#f1c7be}.notice h3{margin:0 0 5px;font-size:17px}.notice p{margin:0}.advice{display:grid;gap:10px}.advice div{padding:12px;border-radius:14px;background:#f5f8f4}.advice b{display:block;font-size:14px;color:var(--green);margin-bottom:3px}.toolbar{padding:11px 12px;margin-top:0}.toolbarMain{display:grid;grid-template-columns:64px minmax(0,1fr) 64px;gap:7px;align-items:center}.toolbar button{white-space:nowrap;font-size:14px;padding:10px 5px}.datepick{width:100%;font:inherit;border:1px solid var(--line);padding:10px 6px;border-radius:11px;background:#fff;text-align:center}.toolbarActions{display:flex;gap:7px;margin-top:8px}.toolbarActions button{flex:1}.toolbarActions .ghost{background:#f3e6dc}.foodSearch{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:7px;align-items:center;margin-top:10px}.foodSearch label{font-size:15px;font-weight:850;white-space:nowrap}.foodSearch input{min-width:0;width:100%;font:inherit;border:1px solid var(--line);padding:9px 10px;border-radius:11px;background:#fff}.foodSearch button{padding:9px 10px}.foodSearchResults{display:grid;gap:6px;margin-top:8px}.foodSearchResult{width:100%;text-align:left;background:#fff7ef;color:var(--ink);border:1px solid var(--line);font-weight:700;padding:9px 10px}.foodSearchResult small{display:block;color:var(--muted);font-weight:600;margin-top:2px}button{font:inherit;border:0;border-radius:12px;padding:10px 12px;font-weight:800;color:#fff;background:var(--green);cursor:pointer}button.ghost{background:#f3e6dc;color:var(--ink)}button:focus,input:focus{outline:3px solid #e8bd9f;outline-offset:2px}.help{font-size:14px;color:var(--muted);margin-top:9px}.details summary{font-weight:800;cursor:pointer;color:var(--green)}.details{font-size:15px}.hidden{display:none!important}.manager{border:2px dashed #bfdbc7}.manager label{display:block;font-size:15px;font-weight:800;margin:12px 0 5px}.manager input,.manager textarea{width:100%;font:inherit;border:1px solid var(--line);border-radius:11px;padding:10px;background:#fff}.manager textarea{min-height:64px}.row{display:flex;gap:9px;margin:10px 0;flex-wrap:wrap}.record{border-top:1px solid var(--line);padding:10px 0;font-size:15px}.pause{background:var(--rose);border-color:#edc3b9}@media(max-width:390px){.shell{padding:12px 9px 44px}.card{padding:14px}.toolbar{padding:10px}.toolbarMain{grid-template-columns:62px 1fr 62px}.toolbar button{padding:10px 3px}.title{font-size:26px}.foodGrid{grid-template-columns:1fr}.foodName{font-size:16px}}
</style></head><body><main class="shell"><header class="top"><div class="brand">球球今天吃什么<small>辅食日历 · 家人查看版</small></div></header><section class="card toolbar" aria-label="日期、分享和设置"><div class="toolbarMain"><button class="ghost" id="prev" aria-label="前一天">← 前一天</button><input id="pick" class="datepick" type="date" aria-label="选择日期"><button class="ghost" id="next" aria-label="后一天">后一天 →</button></div><div class="toolbarActions"><button class="ghost" id="goToday">今天</button><button id="share">分享链接</button><button class="ghost" id="openManage">设置</button></div><div class="foodSearch"><label for="foodQuery">找食物</label><input id="foodQuery" type="search" inputmode="search" autocomplete="off" placeholder="如：鳕鱼、鸡蛋、南瓜" aria-describedby="foodSearchHelp"><button class="ghost" id="clearFoodSearch" type="button">清除</button></div><div class="help" id="foodSearchHelp">输入食物名称，查看计划中安排在哪一天、哪一餐。</div><div class="foodSearchResults hidden" id="foodSearchResults" aria-live="polite"></div><div class="help" id="shareHint"></div></section><section class="card hero" id="hero"></section><section class="card" id="meals"></section><section class="card notice" id="observe"></section><section class="card" id="adviceCard"><div class="advice" id="advice"></div></section><details class="card details"><summary>给家里人的安全提醒</summary><p>坐稳、全程看护，不强喂。食物做软、做碎、做湿润；整粒坚果、整颗葡萄、硬块、生食、带刺鱼和烫食都不喂。出现呼吸困难、反复呕吐、面唇舌肿、全身风团等，立即就医。</p></details><section class="card manager hidden" id="manager"><h2 style="margin-top:0">管理员设置</h2><div class="help">修改后请点上方“分享链接”发到群里；家人用该链接打开，会看到相同的开始日期和暂停记录。</div><label>实际开始日期</label><input id="start" type="date"><button id="saveStart" style="margin-top:9px">保存开始日期</button><hr style="border:0;border-top:1px solid var(--line);margin:20px 0"><h3>当天暂停、计划顺延</h3><div class="help">暂停日不消耗计划进度，下一天继续同一份计划。</div><label>暂停日期</label><input id="pauseDate" type="date"><label>原因（选填）</label><textarea id="pauseReason" placeholder="如：接种后不适、出门"></textarea><button id="addPause" style="margin-top:9px;background:#b6594e">记录暂停并顺延</button><h3>已记录暂停</h3><div id="pauseList" class="help"></div></section></main><script>
